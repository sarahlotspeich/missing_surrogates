...
sim_res = read.csv("https://raw.githubusercontent.com/sarahlotspeich/missing_surrogates/refs/heads/main/simulations/sett5_non_overlap.csv") |> 
...
ggsave(filename = "figures/sett5_non_overlap_boxplot.pdf", 
